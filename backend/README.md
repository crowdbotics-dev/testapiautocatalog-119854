...
## Project Structure
    ...
    ├── testapiautocatalog_119854  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_119854`
...
2. Clone this repo and `cd testapiautocatalog_119854`
